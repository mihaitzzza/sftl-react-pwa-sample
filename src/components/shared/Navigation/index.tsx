        ...
        <>
            <Box sx={{flexGrow: 1}}>
                <AppBar position="static">
                    <Toolbar>
                        <Stack sx={{flexGrow: 1}} spacing={1} direction="row" alignItems="center">
                            <img src="/images/brand/logoSymbolWhite.png" height="25px" alt="White Logo" />
                        ...
                        </Stack>
                        {
                            isMobile ? (
                                ...
                                <Stack className="sftl-nav-links" direction="row" spacing={4} alignItems="center">
